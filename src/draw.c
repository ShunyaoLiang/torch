...
void draw_game(void)
{
	...
	ui_draw_format_at(view_lines-1, 10, "Torches: %-3d", (struct ui_cell_attr){ .fg = barfg }, player_torches);

#define HPBARLEN 10
	ui_draw_format_at(view_lines-1, 24, "HP: %-3d", (struct ui_cell_attr){ .fg = barfg }, player.combat.hp);
